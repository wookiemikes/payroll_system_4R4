...
public class StudentController {
	...
	public String addSubject(String subject_name) {
		System.out.println("Test");

		logger.info("Adding subject: " + subject_name);

		try {
			
			// add student to the database
			studentDbUtil.addSubject(subject_name);
			
		} catch (Exception exc) {
			// send this to server logs
			logger.log(Level.SEVERE, "Error adding subject", exc);
